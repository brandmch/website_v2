          ...
          <Box marginBottom={4} marginTop={4}>
            <Paper elevation={4}>
              <Box padding={2.5}>
                ...
                <hr />
                <Typography variant="h6">OtherWhy LLC</Typography>
                <Typography variant="h6">Procore Technologies</Typography>
                <Typography variant="h6">Advanced Systems Concepts</Typography>
              </Box>
            </Paper>
          </Box>
